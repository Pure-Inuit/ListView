...
public class StudentInfo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = (ImageView) findViewById(R.id.studentHeadSculpture);
        imageView.setImageResource(head_sculpture[position]);

        TextView textView = (TextView) findViewById(R.id.studentID);
        textView.setText(String.valueOf(studentID[position]));

        TextView textView2 = (TextView) findViewById(R.id.studentName);
        textView2.setText(String.valueOf(studentName[position]));

        TextView textView3 = (TextView) findViewById(R.id.studentRemarks);
        textView3.setText(String.valueOf(studentName[position]) + "是一个好学生！！！");
